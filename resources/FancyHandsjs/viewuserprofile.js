$(document).ready(function () {
    ...
    success:function(result,status){
        ...
        for (key in result){
            $('#usersData').
            append('<div class="userdetailfloat col-lg-3 col-md-6 mb-4"> <div class="card hirer-section">\n' +

                '            <div class="picture-padding"><a href="" id="hire" data-toggle="modal" data-target="#hireme" employeeid="'+result[key].employeeId+'">' +
                '<img class="card-img-top " src="file:///home/mamata/Desktop/API Web Assignment/backend-Web-API-Mamata/uploads/'+result[key].image +'" alt="product" height="200px" width="200px"></a></div>\n' +
                '        ' +
                '            <div class="card-body">\n' +
                ...
                '              <p><input type="button" class="btn btn-primary mybutton" uid="'+ result[key].userId + '" ' +
