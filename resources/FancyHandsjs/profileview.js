$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function(result,status) {
            ...
            $('#myprofile').append(' <div class="col-md-1"></div><div class="gender-photo">\n' +
                '                    <img src="file:///home/mamata/Desktop/API Web Assignment/backend-Web-API-Mamata/uploads/'+result.image +'" alt="image" height="220px" width="263px" class="user-pro">\n' +
                '\n' +
                '                </div></div>\n' +
