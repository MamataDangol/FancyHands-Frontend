        ...
        $.ajax({
            ...
            success: function(result,status) {
                ...
                $('#userdropdowndetail').append(
                    ...
                    '                      <div class="image-pad" >\n' +
                    '                        <img class="card-img-top-lg-5" src="file:///home/mamata/Desktop/API Web Assignment/backend-Web-API-Mamata/uploads/'+image+'"\n' +
                    ...
                    '\n' +
                    '                          <button class="btn btn-primary" id="btnhireme" uid="'+userid+'" ' +
    ...
    $.ajax({
        ...
        success:function(result,status){
            ...
            for (key in result){
                ...
                append('   <tr >\n' +
                    '                <td align="center">\n' +
                    '                  <img src="file:///home/mamata/Desktop/API Web Assignment/backend-Web-API-Mamata/uploads/'+result[key].image +'" alt="worker image" height="100px" width="140px"></td>\n' +
